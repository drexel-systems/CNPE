# Lab 3 Setup: Pulumi, AWS Credentials, and SSH Key

If you completed Lab 2, your environment is already configured — skip to the **Quick Reference** at the bottom to refresh credentials and confirm everything still works. The one new thing for Lab 3 is SSH agent setup, which is covered in Part 2's lab guide.

If this is your first time setting up, complete all six sections in order.
...
Your Code (__main__.py)
  ...
  Pulumi Engine ──── reads/writes ────▶  State File  (~/.pulumi/)
       │
       ▼
  AWS API ──── creates/modifies ────▶  Real Resources (EC2, VPC, ...)
```
...
Run these four commands. All four should succeed before you open the lab guide.
...
All four passing? Open **`lab-p1/lab-guide.md`** and start building.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  EACH LAB (run inside the lab-p1/ directory)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
