...
└── lab2/
    ...
    └── LastName_FirstName_Lab2.pdf   ← screenshots (D1–D7), analytical responses (D8–D11),
                                         and context paragraph (CP), in order with a title page;
                                         include EC1–EC4 at the end if submitting for extra credit
```
